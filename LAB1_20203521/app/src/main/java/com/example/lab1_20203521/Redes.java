...
import com.example.lab1_20203521.Beans.RedesQuiz;
...
public class Redes extends AppCompatActivity {
    ...
    List<List<String>> preguntas = RedesQuiz.getPreguntas();
    ...
    private void mostrarResultadoFinal() {
        ...
        Intent intent = new Intent(Redes.this, ResultadoRedes.class);
